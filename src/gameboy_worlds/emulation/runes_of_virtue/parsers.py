...
class RunesOfVirtue1StateParser(RunesOfVirtueStateParser):
    ...
    MULTI_TARGET_REGIONS = [
        ...
        ("top_45_ui_indicator", 144, 0, 16, 45),
        ("top_85_ui_indicator", 144, 0, 16, 85),
        ("top_40_playfield_indicator", 0, 0, 144, 40),
    ...
    MULTI_TARGETS = {
        ...
        "dialog_indicator": [
            ...
            "cavern_of_cowardice_talk_to_sherry_floor_6",
            "cavern_of_cowardice_talk_to_chuckles_floor_6",
            "cavern_of_hatred_talk_to_klop_floor_5",
            "cavern_of_hatred_talk_to_klip_floor_5",
            "cavern_of_deceit_talk_to_finn_floor_1",
            "cavern_of_deceit_talk_to_kador_floor_3",
            "cavern_of_deceit_talk_to_finn_floor_3",
        ],
        "cave_indicator": [
            "cavern_of_hatred",
            "cavern_of_deceit",
        ...
        "playfield_indicator": [
            ...
            "cavern_of_hatred_talk_to_klop_floor_5",
            "cavern_of_hatred_talk_to_klip_floor_5",
            "cavern_of_hatred_obtain_axe_floor_5",
            "cavern_of_hatred_exited",
            "cavern_of_cowardice_obtain_key_from_dr_cat_floor_5",
            "cavern_of_deceit_enter_east_door_floor_1",
            "cavern_of_cowardice_enter_secret_door_floor_6",
            "cavern_of_cowardice_talk_to_sherry_floor_6",
            "cavern_of_cowardice_talk_to_chuckles_floor_6",
            "cavern_of_deceit_talk_to_kador_floor_3",
            "cavern_of_deceit_talk_to_finn_floor_3",
        ...
        "top_45_ui_indicator": [
            "cavern_of_cowardice_obtain_magic_rope_floor_6",
        ],
        "top_85_ui_indicator": [
            "buy_two_cakes",
        ],
        "top_40_playfield_indicator": [
            "cavern_of_cowardice_enter_floor_5",
            "cavern_of_cowardice_enter_floor_6",
            "cavern_of_hatred_enter_floor_5",
            "cavern_of_deceit_enter_floor_2",
            "cavern_of_deceit_enter_floor_3",
            "cavern_of_deceit_enter_floor_4",
        ],
    ...
    _DIALOG_TARGETS = (
        ...
        ("dialog_indicator", "cavern_of_deceit_talk_to_finn_floor_1"),
        ("dialog_indicator", "cavern_of_cowardice_sherry_floor_4_dialog"),
        ("dialog_indicator", "cavern_of_cowardice_talk_to_sherry_floor_6"),
        ("dialog_indicator", "cavern_of_cowardice_talk_to_chuckles_floor_6"),
        ("dialog_indicator", "cavern_of_hatred_talk_to_klop_floor_5"),
        ("dialog_indicator", "cavern_of_hatred_talk_to_klip_floor_5"),
        ("dialog_indicator", "cavern_of_deceit_talk_to_kador_floor_3"),
        ("dialog_indicator", "cavern_of_deceit_talk_to_finn_floor_3"),
    )
...
class RunesOfVirtue2StateParser(RunesOfVirtueStateParser):
    ...
    MULTI_TARGET_REGIONS: List[Tuple[str, int, int, int, int]] = [
        ...
        ("top_40_playfield_indicator", 0, 0, 144, 40),
        ("top_25_ui_indicator", 144, 0, 16, 25),
    ...
    MULTI_TARGETS = {
        "playfield_indicator": [
            ...
            "cave_of_dishonour_enter_floor_3_blocked",
            "cave_of_dishonour_enter_floor_4",
            ...
            "city_of_yew_entered",
            "cavern_of_injustice_enter_east_portal_floor_3",
        ],
        "left_playfield_indicator": ["cavern_of_hatred_ladder_out_found"],
        "top_40_playfield_indicator": [
            "cave_of_dishonour_exited",
            "cavern_of_injustice_entered",
            "cavern_of_injustice_enter_floor_2",
            "cavern_of_injustice_enter_floor_3",
            "cavern_of_injustice_enter_floor_4",
            "cavern_of_injustice_enter_floor_5",
            "cavern_of_injustice_enter_floor_6",
            "cavern_of_injustice_enter_floor_7",
        ],
        "top_25_ui_indicator": ["cave_of_dishonour_equip_rod_floor_3"],
        "dialog_indicator": [
            "nystul_dialog",
            ...
            "cave_of_dishonour_lord_whitsaber_floor_4",
            "tholden_saved",
            "tholden_brought_back_to_king",
            "castle_ceremony_attended",
            "rune_of_honour_obtained",
            "city_of_yew_welcome_sign_read",
            "mandrake_bard_dialog",
            "cavern_of_injustice_talk_to_zoltan_floor_4",
            "cavern_of_injustice_read_hint_floor_5",
            "cavern_of_injustice_talk_to_terry_floor_5",
        ],
        "death_screen_indicator": ["death_screen"],
    }
    ...
    _DIALOG_TARGETS = (
        ...
        ("dialog_indicator", "cave_of_dishonour_lord_whitsaber_floor_4"),
        ("dialog_indicator", "tholden_saved"),
        ("dialog_indicator", "tholden_brought_back_to_king"),
        ("dialog_indicator", "castle_ceremony_attended"),
        ("dialog_indicator", "rune_of_honour_obtained"),
        ("dialog_indicator", "city_of_yew_welcome_sign_read"),
        ("dialog_indicator", "mandrake_bard_dialog"),
        ("dialog_indicator", "cavern_of_injustice_talk_to_zoltan_floor_4"),
        ("dialog_indicator", "cavern_of_injustice_read_hint_floor_5"),
        ("dialog_indicator", "cavern_of_injustice_talk_to_terry_floor_5"),
    )
    """ Multi-target screen regions that indicate an NPC dialogue overlay is visible. """
